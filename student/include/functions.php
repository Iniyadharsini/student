...
function displayCoursesStudent()
{
    ...
    $content = "<tr class=\"text-center\">";
    $content .=      "<td>".$row["S.No."]."</td>";
    $content .=      "<td>".$row["Course Code"]."</td>";
    $content .=      "<td>".$row["Course Name"]."</td>";
    $content .=      "<td>".$row["Course Type"]."</td>";
    $content .=      "<td>".$row["Status"]."</td>";
    // $content .=      "<td>".courseTypeText($row["Course Type"])."</td>";
